...
export default function WelcomePage() {
  ...
  const yText = useTransform(scrollY, [0, 200, 500], [0, 50, 300]);
  const scaleText = useTransform(scrollY, [0, 200, 500], [1, 1.2, 1.5]);
  const yCity = useTransform(scrollY, [0, 200], [0, -100]);
  const opacityCity = useTransform(scrollY, [0, 200, 300, 500], [1, 0.8, 0.5, 0]);
